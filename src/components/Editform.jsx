  ...
  return (
    <div className='text-black'>
        <form onSubmit={handlesubmit} action="">
            <div className={`${item.isCompleted?" bg-green-600 ":"bg-fuchsia-900"} max-w-xs w-80 h-64  rounded-md border border-double border-slate-900 shadow-md  dark:text-gray-800 `}>
            <div className="flex flex-col justify-between items-center p-6 space-y-8 h-full">
              ...
              <div className='flex gap-3 mt-10 items-center h-full'>
                ...
                <button type="submit"  className="flex items-center justify-center w-24 p-3 font-semibold tracking-wide rounded-md text-green-600 bg-black">Update</button>
